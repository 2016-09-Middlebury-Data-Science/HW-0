...
You are currently in the GitHub repository (repo) for `HW-0`. You must have
...
research that allows for seamless integration between R code, R output, graphs,
and text input. For those of you new to it, you'll see why it makes sharing
statistical analyses easy in `HW-0.Rmd`.
...
then inspect the proposed changes. This make collaboration on very large
...
1. Once you've forked a copy of HW-X, you should only be looking at the GitHub page of
    ...
    * and not the original master repo marked
    "2016-09-Middlebury-Data-Science/HW-X".
